...
CREATE TABLE `Analysis` (
  ...
  `ResultGiven` tinyint(1) DEFAULT NULL,
  `Coverage` float DEFAULT NULL,
  `MeanDepth` float DEFAULT NULL,
  `NumberReads` int DEFAULT NULL,
  `Uniformity` float DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `Analysis_Plans_FK` (`Plan`),
  CONSTRAINT `Analysis_Plans_FK` FOREIGN KEY (`Plan`) REFERENCES `Plans` (`UniquelID`)
...
CREATE TABLE `Families` (
  ...
  `Inbreeding` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Patients` (
  ...
  `FamilyRelation` varchar(100) DEFAULT NULL,
  `Birthday` date DEFAULT NULL,
  `Diagnosis` varchar(100) DEFAULT NULL,
  `MedCardNumber` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`PatientID`),
  KEY `Patients_Gender_FK` (`Sex`),
  KEY `Patients_Families_FK` (`FamilyID`),
  KEY `Patients_ICD_FK` (`Diagnosis`),
  CONSTRAINT `Patients_Families_FK` FOREIGN KEY (`FamilyID`) REFERENCES `Families` (`ID`),
  CONSTRAINT `Patients_Gender_FK` FOREIGN KEY (`Sex`) REFERENCES `Gender` (`ID`),
  CONSTRAINT `Patients_ICD_FK` FOREIGN KEY (`Diagnosis`) REFERENCES `ICD` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `Plans` (
  `UniquelID` int NOT NULL,
  `Sample` int DEFAULT NULL,
  `SequencingType` int DEFAULT NULL,
  PRIMARY KEY (`UniquelID`),
  KEY `Plans_Samples_FK` (`Sample`),
  KEY `Plans_SequencingType_FK` (`SequencingType`),
  CONSTRAINT `Plans_Samples_FK` FOREIGN KEY (`Sample`) REFERENCES `Samples` (`UIN1`),
  CONSTRAINT `Plans_SequencingType_FK` FOREIGN KEY (`SequencingType`) REFERENCES `SequencingType` (`UniqueID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Runs` (
  `Name` varchar(100) NOT NULL,
  `SequencingData` varchar(100) DEFAULT NULL,
  `Plan` int DEFAULT NULL,
  `Model` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`Name`),
  KEY `Runs_Plans_FK` (`Plan`),
  CONSTRAINT `Runs_Plans_FK` FOREIGN KEY (`Plan`) REFERENCES `Plans` (`UniquelID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Samples` (
  `UIN1` int NOT NULL,
  `UIN2` varchar(100) DEFAULT NULL,
  `Patient` int DEFAULT NULL,
  `Run` varchar(100) DEFAULT NULL,
  `Project` int DEFAULT NULL,
  `Deadline` date DEFAULT NULL,
  `AcquiringDate` date DEFAULT NULL,
  PRIMARY KEY (`UIN1`),
  KEY `Samples_Patients_FK` (`Patient`),
  KEY `Samples_Projects_FK` (`Project`),
  KEY `Samples_Runs_FK` (`Run`),
  CONSTRAINT `Samples_Patients_FK` FOREIGN KEY (`Patient`) REFERENCES `Patients` (`PatientID`),
  CONSTRAINT `Samples_Projects_FK` FOREIGN KEY (`Project`) REFERENCES `Projects` (`ID`),
  CONSTRAINT `Samples_Runs_FK` FOREIGN KEY (`Run`) REFERENCES `Runs` (`Name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `SequencingType`
--

DROP TABLE IF EXISTS `SequencingType`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `SequencingType` (
...
--
-- Dumping data for table `SequencingType`
--

LOCK TABLES `SequencingType` WRITE;
/*!40000 ALTER TABLE `SequencingType` DISABLE KEYS */;
/*!40000 ALTER TABLE `SequencingType` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2025-04-11 08:14:08',NULL),('diagnostics.include_raw','OFF','2025-04-11 08:14:08',NULL),('ps_thread_trx_info.max_length','65535','2025-04-11 08:14:08',NULL),('statement_performance_analyzer.limit','100','2025-04-11 08:14:08',NULL),('statement_performance_analyzer.view',NULL,'2025-04-11 08:14:08',NULL),('statement_truncate_len','64','2025-04-11 08:14:08',NULL);
...
-- Dump completed on 2025-05-16  4:11:00
